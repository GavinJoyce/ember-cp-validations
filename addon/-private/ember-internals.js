...
export function getDependantKeys(descriptorOrDecorator) {
  if (__EMBER_METAL__.descriptorForDecorator) {
    let descriptor = __EMBER_METAL__.descriptorForDecorator(descriptorOrDecorator);
